...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    {
        // Two swaps, one policy: this application has no recovery codes.
        // Fortify resolves both of these from the container, so replacing them
        // here closes the path everywhere rather than at each call site.
